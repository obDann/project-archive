...
public class InvalidCommandError extends Exception {
  /**
   * Creates an InvalidCommandError object, acting as an exception
   */
  ...
  /**
   * Creates an InvalidCommandError object, acting as an exception with the
   * addition of obtaining a message
   *
   * @param msg the message relative to InvalidCommandError
   */
