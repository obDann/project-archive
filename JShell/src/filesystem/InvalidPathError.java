...
public class InvalidPathError extends Exception {
  /**
   * Creates an InvalidPathError object, acting as an exception
   */
  public InvalidPathError () {
    super();
  }
  /**
   * Creates a InvalidPathError object, acting as an exception with the
   * addition of obtaining a message
   *
   * @param msg the message relative to InvalidPathError
   */
  public InvalidPathError (String msg) {
    super(msg);
  }
