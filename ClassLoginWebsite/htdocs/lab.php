...
<body>
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <!--Lab Material heading.-->
      <h1 id="pg_title">Lab Material</h1>

      <!--Week 1 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start1">
      ...
      <!--Week 2 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start2">
      ...
      <!--Week 3 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start3">
      ...
      <!--Week 4 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start4">
      ...
      <!--Week 5 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start5">
      ...
      <!--Week 6 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start6">
      ...
      <!--Week 7 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start7">
      ...
      <!--Week 8 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start8">
      ...
      <!--Week 9 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start9">
      ...
      <!--Week 10 box.-->
      <div class="material_grouping">
        <div class="title_block" id="lab_start10">
