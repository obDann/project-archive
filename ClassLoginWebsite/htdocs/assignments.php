...
<body>
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <!--Assignments heading.-->
      <h1 id="pg_title">Assignments</h1>
      
      <!--Assignment 1 box.-->
      <div class="material_grouping">
        <div class="title_block" id="ass_start1">
          <div class="title"> Assignment 1: MySQL and Relational Algebra - Worth 10%</div>
        </div>
          <ul>
      ...
      <!--Assignment 2 box.-->
      <div class="material_grouping">
        <div class="title_block" id="ass_start2">
          <div class="title"> Assignment 2: HTML and CSS - Worth 10%</div>
        </div>
        <ul>
          <li><a href="" class="handout">handout</a></li>
          <li><a href="" class="starter">starter</a></li>
      ...
      <!--Assignment 3 box.-->
      <div class="material_grouping">
        <div class="title_block" id="ass_start3">
          <div class="title"> Assignment 3: PHP and SQL - Worth 10%</div>
        </div>
        <ul>
          <li><a href="" class="handout">handout</a></li>
          <li><a href="" class="starter">starter</a></li>
