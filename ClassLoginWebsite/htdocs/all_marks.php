  ...
  <div class="main">
    ...
    <div class="content">
      <?php
        ...
        // we want to show lab 1 marks (if available)
        $content  = "Lab 1";
        // then show its table
        include "marks_module.php";
        
        // we want to show lab 2 marks (if available)
        $content  = "Lab 2";
        // then show its table
        include "marks_module.php";
        
        // we want to show lab 3 marks (if available)
        $content  = "Lab 3";
        // then show its table
        include "marks_module.php";
        
        // we want to show assignment 1 marks (if available)
        $content  = "Assignment 1";
        // then show its table
        include "marks_module.php";

        // we want to show assignment 2 marks (if available)
        $content  = "Assignment 2";
        // then show its table
        include "marks_module.php";

        // we want to show TT1 marks (if available)
        $content  = "Term Test 1";
        // then show its table
        include "marks_module.php";
        
        // we want to show TT2 marks (if available)
        $content  = "Term Test 2";
        // then show its table
        include "marks_module.php";
        
        // we want to show Final Exam marks (if available)
        $content  = "Final Exam";
        // then show its table
        include "marks_module.php";
      ?>
