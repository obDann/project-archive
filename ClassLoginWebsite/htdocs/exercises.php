...
<body>
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <!--Exercises heading.-->
      <h1 id="pg_title">Exercises</h1>

      <!--Exercise 1 box.-->
      <div class="material_grouping">
        <div class="title_block" id="exc_start1">
          <div class="title"> Exercise 1: Relational Algebra - Worth 1%</div>
        </div>
        <ul>
          <li><a href="" class="handout">handout</a></li>
          <li><a href="" class="starter">starter</a></li>
        </ul>
      </div>

      <!--Exercise 2 box.-->
      <div class="material_grouping">
        <div class="title_block" id="exc_start2">
          <div class="title"> Exercise 2: MySQL - Worth 1%</div>
        </div>
        <ul>
          <li><a href="" class="handout">handout</a></li>
          <li><a href="" class="starter">starter</a></li>
      ...
      <!--Exercise 3 box.-->
      <div class="material_grouping">
        <div class="title_block" id="exc_start3">
          <div class="title"> Exercise 3: HTML and CSS- Worth 1%</div>
        </div>
        <ul>
          <li><a href="" class="handout">handout</a></li>
          <li><a href="" class="starter">starter</a></li>
      ...
      <!--Exercise 4 box.-->
      <div class="material_grouping">
        <div class="title_block" id="exc_start4">
          <div class="title"> Exercise 4: JavaScript- Worth 1%</div>
        </div>
        <ul>
          <li><a href="" class="handout">handout</a></li>
          <li><a href="" class="starter">starter</a></li>
      ...
      <!--Exercise 5 box.-->
      <div class="material_grouping">
        <div class="title_block" id="exc_start5">
          <div class="title"> Exercise 5: PHP- Worth 1%</div>
        </div>
        <ul>
          <li><a href="" class="handout">handout</a></li>
          <li><a href="" class="starter">starter</a></li>
