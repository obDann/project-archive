...
<body>
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <!--Exams heading.-->
      <h1 id="pg_title">Exams</h1>
      
      <!--Midterms box.-->
      <div class="material_grouping">
        <div class="title_block" id="tes_start1">
          <div class="title">Previous year's midterms</div>
        </div>
        <ul>
          ...
          <li><a href="" class="year">2012</a></li>
          <li><a href="" class="year">2011</a></li>
          <li><a href="" class="year">2010</a></li>
        </ul>
      </div>

      <!--Finals box.-->
      <div class="material_grouping">
        <div class="title_block" id="tes_start2">
          <div class="title">Previous year's finals</div>
        </div>
        <ul>
          <li><a href="" class="year">2017</a></li>
          <li><a href="" class="year">2016</a></li>
